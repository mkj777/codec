...
public sealed class UpdateService
{
    ...
    public async Task CheckAndDownloadAsync()
    {
        ...
        try
        {
            ...
            {
                ErrorMessage = "App not installed via Velopack. Run the Setup.exe generated by `vpk pack` instead of launching the raw build.";
                Debug.WriteLine("[UpdateService] Not installed via Velopack — skipping check");
